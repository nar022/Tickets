...
import styles from "./ThisQuarter.module.css";
...
const columns = [
  ...
  },
  {
    ...
    key: "subject",
    render: (text, record) => (
      <Link to={`/thisquarter-details/${record.key}`}>{text}</Link>
    ),
  },
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.headerContainer}>
        <h2 className={styles.header}>This Quarter</h2>
